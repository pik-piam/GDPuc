...
i.e. [`GDPuc::toolConvertGDP()`](https://pik-piam.github.io/GDPuc/reference/convertGDP.md)
and
[`GDPuc::toolConvertSingle()`](https://pik-piam.github.io/GDPuc/reference/convertGDP.md),
for the madrat caching to work and include the GDPuc function.
