...
**To note:** The default conversion parameters are from the World Bank's World Development Indicators (WDI) database (see [link](https://databank.worldbank.org/source/world-development-indicators)). The current parameters are from **January 2nd 2024**, with the next update planned for January 2025.
